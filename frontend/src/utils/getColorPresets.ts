...
export const colorPresets: ColorPreset[] = [
  ...
  {
    name: "default",
    ...(palette.light.primary as Omit<ColorPreset, "name">),
  },
  // PURPLE
  {
    name: "purple",
...
type ColorPresetKey = "purple" | "cyan" | "blue" | "orange" | "red" | "default";

export default function getColorPresets(
  presetsKey: string
): ColorPreset | undefined {
  const presets: Record<ColorPresetKey, ColorPreset> = {
    purple: purplePreset,
    cyan: cyanPreset,
    blue: bluePreset,
    orange: orangePreset,
  ...
  return presets[presetsKey as ColorPresetKey];
}
