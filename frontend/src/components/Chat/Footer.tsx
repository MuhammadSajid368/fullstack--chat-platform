...
// InputAdornment alias whose `position` prop is optional, to match the
// original markup which omitted it (preserves identical runtime output).
const Adornment = InputAdornment as ComponentType<
...
const ChatInput = ({ openPicker, setOpenPicker }: ChatInputProps) => {
